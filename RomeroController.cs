...
public class RomeroController : MonoBehaviour
{
                ...
                if (!isDead)
                {
                    if (checkNear())
                    {
                        ...
                        if (attack)
                        {
                            ...
                            animator.Play("Stable Sword Outward Slash");
                        }
                        else
                        {
                            if (!audioSource.isPlaying)
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        {
            attack = true;
            PlayerManager.instance.isAttacked(4);
            Debug.Log(attack);
        }
